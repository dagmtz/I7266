 ...
 * 
 * Created: 24/07/2023 12:43:42 p. m.
 *  Author: dagmtz
 */ 
...
/**********************************************
 ...
 Purpose: Signal start TWI/I2C transmission
...
/**********************************************
 Public Function: I2C_write_sla
 
 Purpose: Start TWI/I2C interface
 
 Input Parameter:
 - uint8_t I2C_addr: Adress of reciever (use 
