...
\begin{frame}
  ...
  % Here I'd explain how integers are stored and different types of integers
\end{frame}
%---------------------------------------------------------
...
\begin{frame}
  ...
  % Here I'd explain how integers can have different sizes
\end{frame}
%---------------------------------------------------------
...
\begin{frame}
  \frametitle{Integers in C (cont.)}
  % Here I'd explain how integers can have different signedness
\end{frame}
%---------------------------------------------------------
...
\begin{frame}
  ...
  % Exponent (E): Adjusts the range of the number (powers of 2).
  % Mantissa (M): Holds the significant digits of the number.
...
\begin{frame}
  \frametitle{Floating point numbers (cont.)}
  % To represent -13.25: (single precission example)
...
\begin{frame}
  \frametitle{Arrays}
  % Here I'd explain how floating point numbers are stored
\end{frame}
%---------------------------------------------------------
